...
const AccessoriesPage = () => {
    ...
    const { accessories } = useWedding();
    const utilityType: Utility = Utility.ACCESSORIES;
        ...
        <>
            ...
            <Stack w={'6xl'} mx={'auto'} my={10} gap={5} pos={'relative'}>
                        ...
                        {products.length > 0 ? (
                            ...
                            >
                                {products.map(product => (
                                    <ProductItem type="accessories" product={product} />
                                ))}
                ...
                <HStack justify={'space-between'}>
                    ...
                    <Button variant={'ghost'} rightIcon={<ArrowForward />} onClick={() => navigate(`/wedding-planning/${param.budget}/makeup`)}>
                        {accessories.length > 0 ? 'Bước tiếp theo' : 'Bỏ qua'}
                    </Button>
                </HStack>
            </Stack>
        </>
